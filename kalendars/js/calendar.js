...
(function(){
  ...
  // full shift (sample04 sample05 → "12h DIENA" on 01.08.2026, though row 28 of the
  ...
  const PHANTOM_WORKER_NAMES = ['sample04 sample05'];
  ...
  function isKnownSplitNightCarryover(worker, dateStr) {
    ...
    return hours === 8 && (compactName.includes('sample06') || compactName.includes('sample13'));
  }
