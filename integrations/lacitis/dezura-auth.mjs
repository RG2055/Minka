...
export function cleanRadio(data={}){
 ...
 if(['classic','clean','pioneer','pixel','amp','dither'].includes(s.layout))out.settings.layout=s.layout;
 ...
 if(['bayer','field','rowled','torus'].includes(s.ditherVis))out.settings.ditherVis=s.ditherVis;
