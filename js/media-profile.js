...
(function(){
 ...
 function localLookSettings(value={}){
  const out={};if(['classic','clean','pioneer','pixel'].includes(value.layout))out.layout=value.layout;
