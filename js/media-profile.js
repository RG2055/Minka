...
(function(){
 ...
 function localLookSettings(value={}){
  const out={};if(['classic','clean','pioneer','pixel','amp'].includes(value.layout))out.layout=value.layout;
